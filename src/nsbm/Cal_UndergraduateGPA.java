 ...
 * @author Asus
 */
public class Cal_UndergraduateGPA extends javax.swing.JFrame {

    /**
     * Creates new form Cal_UndergraduateGPA
     */
    public Cal_UndergraduateGPA() {
        initComponents();
    }
    void calResult(){
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(179, 26, 255));
        ...
        txtSub4Res.setEditable(false);
        txtSub4Res.setBackground(new java.awt.Color(250, 245, 245));
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        try{
            if(rs.next()){
                txtMainSub1Res.setText(rs.getString("MainSub1"));
                txtMainSub2Res.setText(rs.getString("MainSub2"));
                txtSub1Res.setText(rs.getString("Sub1"));
                txtSub2Res.setText(rs.getString("Sub2"));
                txtSub3Res.setText(rs.getString("Sub3"));
                txtSub4Res.setText(rs.getString("Sub4"));
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cal_UndergraduateGPA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cal_UndergraduateGPA().setVisible(true);
            }
        });
    }
